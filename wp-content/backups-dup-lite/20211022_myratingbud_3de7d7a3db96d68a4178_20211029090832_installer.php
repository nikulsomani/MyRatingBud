...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211022_myratingbud_3de7d7a3db96d68a4178_20211029090832_archive.daf';
	const ARCHIVE_SIZE		 = '58217201';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3de7d7a-29090832';
    const SECONDARY_PACKAGE_HASH = '23fab1a-29090832';
	const VERSION			 = '1.4.3';
