	...
	<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
		<div class="container clearfix et_menu_container">
			...
			? $logo_size[0]
						...
						ob_start();
						?>
						<div class="header-left logo_container et_pb_column_3_5">
				...
				<div class="header-right et_pb_column_2_5">
					<div class="inner">
						<img src="<?php echo get_site_url(); ?>/wp-content/uploads/2021/10/fire-icon.png">
						<h3 class="products-rate">0 Products<br>Rated Today</h3>
					</div>
				</div>
